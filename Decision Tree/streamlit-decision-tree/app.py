# https://github.com/campusx-official/streamlit-decision-tree-classifier
# https://github.com/campusx-official/decision-trees/tree/master
...
min_samples_split = st.sidebar.slider(
    "Min Samples Split", 1, X_train.shape[0], 2, key=1234
)
...
if st.sidebar.button("Run Algorithm"):
    ...
    orig = st.pyplot(fig)
    st.subheader(
        "Accuracy for Decision Tree  " + str(round(accuracy_score(y_test, y_pred), 2))
    )
